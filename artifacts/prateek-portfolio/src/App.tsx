...
import { ArrowDown, ArrowUp, ArrowUpRight, Check, ChevronDown, Code2, Download, Github, Linkedin, Mail, MapPin, Menu, Moon, Phone, Radio, Sun, Terminal, X } from 'lucide-react';
